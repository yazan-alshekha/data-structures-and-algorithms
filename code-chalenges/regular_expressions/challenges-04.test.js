...
Without altering the html,
 write a function named generateSubmitButton
...
const generateSubmitButton = () => {
  ...
  let x =$;
  x.html().$('form:last-child').next().append(btn);
...
a regular expression pattern to match all words that begin with a capital letter.
